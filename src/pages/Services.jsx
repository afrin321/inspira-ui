...
function Services() {
  ...
  return (
    <div
      id="service"
      className="h-[400vh] bg-[#E4E3DB] m-0 p-0 flex flex-col relative"
      ref={targetRef}
    >
      <div className="sticky top-0 h-screen overflow-hidden bg-transparent pl-0 ml-0">
        <div className="h-full flex justify-between pt-16 pl-0 ml-0">
          ...
          <motion.img
            ...
            src={Img2}
            className="h-[80%] z-[4] absolute bottom-0 origin-[48%_48%] left-[23%] min-[800px]:max-[1280px]:left-[15%] mb-0"
          />
          <div
          ...
          >
            <div className="sticky r-0 w-auto flex flex-col items-end px-20 pt-10 gap-1">
              <p className="z-50 text-[#F7073E] font-normal text-[45px] min-[1920px]:text-[70px] leading-[75px] min-[1920px]:leading-[95px] whitespace-nowrap">
                ¿LO QUE
              </p>
              <p className="z-50 text-[#F7073E] font-bold  text-[45px] min-[1920px]:text-[70px] leading-[75px] min-[1920px]:leading-[95px]  whitespace-nowrap">
                HACEMOS?{' '}
              </p>
            </div>
            <div
            ...
            >
              ...
              >
                <p className="font-bold text-[#FF6F1F] text-md  min-[1920px]:text-[28px] min-[1920px]:leading-[40px] ">
                  ADAPTACIÓN DE EMPAQUE.
                </p>
              ...
              <motion.div
                ...
                className={`w-full flex flex-col px-20 min-[1920px]:px-10 gap-2 whitespace-pre-wrap absolute max-[1390px]:bottom-[-15%] min-[1400px]:bottom-[-40%] 2xl:bottom-[-30%] opacity-40 2xl:text-xl gestion`}
              >
                <p className="font-bold text-[#FF6F1F] text-md  min-[1920px]:text-[28px] min-[1920px]:leading-[40px]">
                  COMUNICACIÓN GRÁFICA POP Y OOH.
                </p>

                <p className="text-[#A49090] font-medium text-md whitespace-normal min-[1920px]:text-[28px] min-[1920px]:leading-[40px]">
                  Aseguramos la iconicidad de la marca y la claridad del mensaje
              ...
              <motion.div
                ...
                className={`w-full flex flex-col px-20  min-[1920px]:px-10 gap-2 whitespace-pre-wrap absolute max-[1390px]:bottom-[-20%] min-[1400px]:bottom-[-50%] 2xl:bottom-[-45%] 2xl:text-xl imagenchida`}
              >
                <p className="font-bold text-[#FF6F1F] min-[1920px]:text-[28px] min-[1920px]:leading-[40px] ">
                  GESTIÓN DE MARCA EN PROCESOS DE ETIQUETADO.
                </p>

                <p className="text-[#A49090] font-medium text-md whitespace-normal min-[1920px]:text-[28px] min-[1920px]:leading-[40px]">
                  Lideramos el proceso desde diseño hasta producción. Nos
                  aseguramos de cumplir con los requisitos de calidad en los
                  mejores tiempos.
                </p>
              </motion.div>
              ...
              <motion.div
                ...
                className={`w-full flex flex-col px-20  min-[1920px]:px-10 gap-2 whitespace-pre-wrap absolute max-[1390px]:bottom-[-35%] min-[1400px]:bottom-[-60%] 2xl:bottom-[-60%] 2xl:text-xl comunicacion`}
              >
                <p className="font-bold text-[#FF6F1F] min-[1920px]:text-[28px] min-[1920px]:leading-[40px]">
                ...
                <p className="text-[#A49090] font-medium text-md whitespace-normal min-[1920px]:text-[28px] min-[1920px]:leading-[40px]">
                  Maximizamos el potencial de un master graphic a través del
                  photo shooting.
                </p>
              </motion.div>
            </div>
