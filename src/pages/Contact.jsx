...
import Graphics from './../assets/graphics_4.png'
    ...
    <section id='contact' className='relative bg-[#E4E3DB] m-0 p-0 flex flex-col w-full h-screen'>
      ...
      <div className='w-full clear-start overflow-hidden relative flex gap-5 '>
        ...
        <div className='h-fit w-[50%] flex flex-col justify-start items-end gap-1 mt-[5%] min-[1920px]:mt-[12%] mr-[7.5%]'>
          <p className='my-5 text-[45px] min-[1920px]:text-[70px] leading-[75px] min-[1920px]:leading-[95px] whitespace-nowrap font-medium text-[#F7073E] flex justify-end '>PLATIQUEMOS</p>
          ...
          <p className='flex w-full justify-center items-center min-[1920px]:items-end align-middle'>
            <button className='mt-3 min-[1920px]:mt-8 bg-[#ff4b72] px-10 py-2 text-white rounded-full text-18  min-[1920px]:text-[30px] min-[1920px]:leading-[50px] min-[1920px]:w-[260px]'>ENVIAR</button>
          </p>
        </div>
      </div>
