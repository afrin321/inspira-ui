  ...
  return (
    <section id='quality' className='qualities m-0 p-0 flex flex-col w-full h-screen'>
      ...
      <div className='py-1 h-full w-full m-0 flex flex-col pt-24 px-[8%]'>
        <div className='py-1'><span className='text-white whitespace-nowrap text-[45px] min-[1920px]:text-[70px] leading-[75px] min-[1920px]:leading-[95px]'>CASOS QUE NOS SIGUEN <b>INSPIRANDO</b> </span></div>
        <div className='flex justify-between gap-2 h-full py-2'>
            <motion.div 
              ...
              rounded-xl case1 p-0 transition-all`}>
                <div className={`rounded-xl w-full h-full ${hoverElement == divA && 'overlay-full'}  overflow-hidden`}>
                  <div 
            ...
            <motion.div
              ...
              rounded-xl case2 p-0 transition-all`}>
                  <div className={`rounded-xl w-full h-full ${hoverElement == divB && 'overlay-full'} overflow-hidden`}>
                    <div 
            ...
            <motion.div 
              ...
              rounded-xl case3 p-0 transition-all`}>
                <div className={`rounded-xl w-full h-full ${hoverElement == divC && 'overlay-full'} overflow-hidden`}>
                  <div 
            ...
            <motion.div 
              ...
              rounded-xl case5 p-0 transition-all`}>
                <div className={`rounded-xl w-full h-full ${hoverElement == divD && 'overlay-full'} overflow-hidden`}>
                  <div 
