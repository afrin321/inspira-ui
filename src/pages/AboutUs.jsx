...
function AboutUs() {
  return (
    <section id='about' className='bg-[#E4E3DB] m-0 p-0 flex flex-col w-full h-screen pt-[8%] px-[7.5%] relative'>
      {/* <OtherNav /> */}
      ...
      <div className='h-full w-full m-0 flex justify-between px-[7.5%] gap-0  overflow-hidden py-0'>
        <div className='flex flex-col justify-around gap-0 h-fit w-full gap-10'>
          <motion.span initial={{opacity:'0%'}} whileInView={{ opacity: '100%'}} transition={{ delay: 2, duration: 1 }} className='text-[#F7073E] text-[70px] leading-[110px] whitespace-nowrap my-0'>¿QUE NOS <b className='font-bold'>INSPIRA</b>? </motion.span>
          <motion.div initial={{opacity:'0%'}} whileInView={{ opacity: '100%'}} transition={{ delay: 3, duration: 1 }}>
        ...
        <div className='w-full h-auto relative p-0 m-0 pt-0 flex justify-end'>
          ...
          src={Gp2} className='w-full absolute bottom-0 max-w-[800px] h-[110%] ' />
        </div>
      </div>
    </section>
  )
