...
function Home(props) {
  return (
    <section id='home' className={`w-full relative h-screen home px-[7.5%] flex flex-col gap-20 pt-[329px] pb-0 m-0 overflow-hidden`}>
        <div className='grid grid-cols-12 gap-1 w-full h-full'>
            <motion.div className='h-auto col-span-5 p-0 m-0 ' initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1, duration:2 }} >
            ...
            <div className='col-span-4 w-full h-full p-0 m-0 flex flex-col justify-start items-start'>
                ...
                <div className='w-full h-[242px] flex flex-col align-middle justify-center'>
                    <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 6.5, duration: 1 }} className='text-white font-medium text-[30px] leading-[50px]'>
                        Soluciones en comunicación gráfica 
                        y gestión de marca para procesos 
                        de etiquetado.
                    </motion.p>
                </div>
