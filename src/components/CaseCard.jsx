            ...
            <div className='m-0 p-0 flex pl-10 '>
                {
                    ...
                    <div className='flex flex-col gap-1 items-start w-[90%]'>
                        ...
                        <Link to={'/case'}><button className='my-5 min-[1920px]:my-2 text-[#F7063E] text-sm rounded-full px-10 min-[1920px]:w-[260px] py-2 bg-white font-semibold min-[1920px]:text-[30px] min-[1920px]:leading-[50px]'>Detalle</button></Link>
                    </div>
                }
            </div>
